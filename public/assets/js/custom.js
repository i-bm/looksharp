(function ($) {
    ...
    $(document).on("click", function (e) {
        if (
            !$(e.target).closest(".language-btn, .search-btn, .search-input")
                .length
        ) {
    ...
    document.querySelectorAll(".upload-inputfile").forEach((input) => {
        input.addEventListener("change", function () {
            ...
            const fieldArea =
                this.closest(".upload-btn").querySelector(".field-area h6");
    ...
    if (mobileMenuBtn && dashboardSidebar) {
        ...
        const navLinks = dashboardSidebar.querySelectorAll(
            ".dashboard-nav-link"
        );
    ...
    // Bottom Navigation - Connect hamburger button in top header
    const mobileMenuBtnTop = document.getElementById("mobileMenuBtnTop");
    if (mobileMenuBtnTop) {
        mobileMenuBtnTop.addEventListener("click", function (e) {
            e.stopPropagation();
            const mobileMenuBtn = document.getElementById("mobileMenuBtn");
            if (mobileMenuBtn) {
                mobileMenuBtn.click();
    ...
    if (bottomNavItems.length > 0) {
        ...
        const currentRouteName = window.location.pathname.toLowerCase();
        ...
        bottomNavItems.forEach(function (item) {
            ...
            if (href && (currentPath === href || currentRoute.includes(href))) {
                ...
                (currentRouteName.includes("opportunit") ||
                    currentRouteName.includes("job") ||
                    currentRouteName.includes("browse"))
            ) {
                item.classList.add("active");
            } else if (
                dataRoute === "applications" &&
                (currentRouteName.includes("application") ||
                    currentRouteName.includes("applied"))
            ) {
                item.classList.add("active");
            } else if (
                dataRoute === "notifications" &&
                currentRouteName.includes("notification")
            ) {
                item.classList.add("active");
            } else if (
                dataRoute === "account" &&
                currentRouteName.includes("profile")
            ) {
                item.classList.add("active");
            }
    ...
    // Dashboard Top Header - User Menu Dropdown
    ...
    // Dashboard Top Header - Search (placeholder for now)
    ...
    // Dashboard Top Header - Messages and Notifications (placeholder)
    const messagesBtn = document.getElementById("messagesBtn");
    const notificationsBtn = document.getElementById("notificationsBtn");

    if (messagesBtn) {
        messagesBtn.addEventListener("click", function () {
            // Messages functionality can be implemented here
    ...
    if (notificationsBtn) {
        notificationsBtn.addEventListener("click", function () {
            // Notifications functionality can be implemented here
