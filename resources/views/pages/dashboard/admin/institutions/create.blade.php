...
<div class="dashboard-container">
    <div class="dashboard-page-header">
        <div>
            ...
            <h1 class="dashboard-page-title">Create Institution</h1>
            <p class="dashboard-page-subtitle">Add a new educational institution</p>
        </div>
    </div>
            ...
            <form method="POST" action="{{ route('admin.institutions.store') }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('student_email_domain') is-invalid @enderror"
                                ...
                                value="{{ old('student_email_domain') }}" placeholder="e.g., ug.edu.gh">
                            @error('student_email_domain')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="form-text text-muted">Email domain for student email verification (e.g.,
                                ug.edu.gh)</small>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('country') is-invalid @enderror" id="country"
                                name="country" value="{{ old('country', 'Ghana') }}">
                            @error('country')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('logo') is-invalid @enderror" id="logo" name="logo"
                        value="{{ old('logo') }}" placeholder="URL to institution logo">
                    @error('logo')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
