...
<div class="dashboard-container">
    <div class="dashboard-page-header">
        <div>
            ...
            <h1 class="dashboard-page-title">Create Career Interest Area</h1>
            <p class="dashboard-page-subtitle">Add a new career interest category or subcategory</p>
        </div>
    </div>
    ...
    <div class="dashboard-card">
        ...
        <div class="dashboard-card-body">
            <form method="POST" action="{{ route('admin.career-interest-areas.store') }}">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <small class="form-text text-muted">Select a parent category to create a subcategory, or leave empty
                        to create a parent category</small>
                </div>
                ...
                <div class="mt-3">
                    <button type="submit" class="btn btn-primary">Create Career Interest Area</button>
