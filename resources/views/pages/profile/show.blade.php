...
<div class="profile-container">
    ...
    <div class="card profile-main-card profile-header-card mb-4">
        <div class="card-body">
            @if($isOwner)
            ...
            <div class="profile-header-section">
                ...
                <div class="profile-info-section">
                    ...
                    <div class="profile-public-url-large mt-2">
                        ...
                        <a href="{{ route('talent.profile.public', ['slug' => $profile->public_url]) }}" target="_blank"
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4 profile-strength-column">
            ...
            <div class="card profile-section-card mb-4">
                <div class="card-body">
                    <div class="profile-section-header-flex-lg">
                        <h3 class="profile-section-title-small">WORK PREFERENCES</h3>
                        @if($isOwner)
            ...
            <!-- Skills Section -->
            @if($profile->skills->count() > 0 || $isOwner)
            <div class="card profile-section-card mb-4">
                <div class="card-body">
                    <div class="profile-section-header-flex-lg">
                        <h3 class="profile-section-title-small">SKILLS</h3>
                        @if($isOwner)
            ...
            <div class="card profile-section-card mb-4">
                <div class="card-body">
                    <div class="profile-section-header-flex-lg">
                        <h3 class="profile-section-title-small">LANGUAGES</h3>
                        @if($isOwner)
            ...
            <div class="card profile-section-card mb-4">
                <div class="card-body">
                    <div class="profile-section-header-flex-lg">
                        <h3 class="profile-section-title-small">HOBBIES</h3>
                        @if($isOwner)
