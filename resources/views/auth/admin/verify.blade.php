        ...
        <div class="row g-0 auth-row">
            ...
            <div class="col-lg-6 auth-form-panel">
                <div class="auth-form-wrapper">
                    ...
                    <form method="POST" action="{{ route('admin.login.verify') }}" id="otp-verify-form">
                        @csrf
                    ...
                    <div class="text-center" style="margin-bottom: 20px;" id="resend-section"
                        data-resend-route="{{ route('admin.login.otp') }}"
                    ...
                    <div class="auth-form-link-container">
                        <a href="{{ route('admin.login') }}" class="auth-form-link">
                            ← Back to login
                        </a>
                    </div>
                </div>
